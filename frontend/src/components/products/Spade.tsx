    ...
    return (
        <section className="root-container">
            ...
            <div className="">
                ...
                <section className="md:px-14 px-5 py-12 sm:py-16 lg:py-20 xl:py-24 root-container flex flex-col items-center justify-center w-full">
                    <div className=" px-4 sm:px-6 lg:px-8  w-full flex flex-col justify-center items-center">
                ...
                Create your own blog with us and launch it with just 4 easy steps
                        ...
                        <ul className="mt-12 w-full  gap-10 flex lg:flex-row flex-col ">
                            <li className="flex-start group relative flex lg:flex-col lg:w-1/5">
                                <span
...
Pick best scenes from Archive or Auto-select for new collection request.</h4>
                ...
                <div className="root-container-separator py-10 md:px-14 px-5">
                    <h2 className='text-center text-2xl font-bold '>Features of Spade</h2>
