...
const LandDeformation = () => {
    const [selectedTab, setSelectedTab] = useState(0);
    const tabs = ['Land Deformation'];

    const renderTabContent = () => {
        switch (selectedTab) {
            case 0:
                return <div><Mission name='About Land Deformation' image={dark1} description='
            ...
            <div className="">
                <div className="flex flex-wrap relative">
                    ...
                    <div className='absolute text-5xl h-full w-full bg-black bg-opacity-50 font-bold text-white'>
                        <h2 className="flex item-center h-full w-full justify-center items-center">Land Deformation</h2>
                    </div>
                </div>
                ...
                <div className="flex root-container-separator md:px-14 pt-10 px-5">
                    {tabs.map((tab, index) => (
                        <button key={index}
                            className={`py-2 px-4 text-lg font-semibold ${selectedTab === index ? 'root-container' : 'text-gray-500'}`}
                ...
                <div className="root-container-separator py-10 md:px-14 px-5">
                    <h2 className='text-center text-3xl font-bold '>Land Deformation</h2>
...
export default LandDeformation