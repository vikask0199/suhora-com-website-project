...
const TerrainMapping = () => {
    ...
    const tabs = ['Terrain Mapping'];

    const renderTabContent = () => {
        switch (selectedTab) {
            case 0:
                return <div><Mission name='About Terrain Mapping' image={dark1} description='
        ...
        <section className="root-container">
            ...
            <div className="">
                ...
                <div className="root-container-separator py-10 md:px-14 px-5">
                    <h2 className='text-center text-3xl font-bold '>Terrain Mapping</h2>
