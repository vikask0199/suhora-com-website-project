...
const Blogs = () => {
  ...
  <div className="flex h-full w-full items-center justify-center container mx-auto px-8">
    <div className="max-w-xl text-center">
        <h2 className="text-3xl sm:text-5xl capitalize tracking-widest text-white lg:text-6xl">BLOGS</h2>
      <h1 className="text-xl sm:text-3xl capitalize tracking-widest text-white lg:text-5xl">Coming Soon</h1>
