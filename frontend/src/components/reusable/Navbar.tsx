...
const Navbar = (props: NavbarProps) => {
  ...
  return (
    <header className={`py-4 ${props.currentTheme === 'theme-dark' ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'} sticky top-0 left-0 right-0 z-20 px-14 border-b border-slate-800`}>
